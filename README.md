...
versions with open licenses only). All public domain or CC BY / CC BY-SA; see
`docs/licensing.md`. The remaining two sources are documented stubs
...
- Two of seven commentary parsers: Ibn Kathir has no English text with a
  shippable license; the ICC is public-domain OCR work.
