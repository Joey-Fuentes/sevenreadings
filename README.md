...
(Catholic). All public domain or CC BY / CC BY-SA; see `docs/licensing.md`.
The other five commentary sources are documented stubs
...
- Five of seven commentary parsers. Ibn Kathir is blocked on finding an
  English text with a shippable license.
- Notes and bookmarks (schema and `UserDb` exist).
