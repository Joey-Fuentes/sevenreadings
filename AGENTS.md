...
- `packaging/flatpak/org.sevenreadings.SevenReadings.yml`,
  `flutter-sdk-*.json`, `pubspec-sources.json` and `setup-flutter.sh` are
  generated by `flatpak-sources.yml` from `flatpak-flutter.template.yml`;
